...
use rklandesverband\visualcaptchark\CaptcharkAsset;
...
//        $this->session->clear();
        ...
        $this->session->set('frontendData', Array('values' => $imageValues, 'imageName' => $validImageOption['name'], 'imageFieldName' => $this->utilRandomHex(10), 'audioFieldName' => $this->utilRandomHex(10)));
    }
    ...
    public function streamAudio($headers, $fileType)
    {
        ...
        $audioFilePath = $this->assetsPath . '/' . $audioFileName;
    ...
    public function streamImage($headers, $index, $isRetina)
    {
        ...
        $imageFilePath = $this->assetsPath . '/' . $imageFileName;
