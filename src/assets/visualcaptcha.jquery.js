...
(function (e, t) {
    ...
    (function (e) {
        ...
        o = function (e, t) {
            ...
            if (y === "undefined" || y === "function") {
                ...
                for (d = 0; d < n.length; d += 1) {
                    p = o(n[d], i), l = p.f;
                    if (l === "require") m[d] = u.require(t); else if (l === "exports") m[d] = u.exports(t), E = !0; else if (l === "module") s = m[d] = u.module(t); else if (v(a, l) || v(f, l) || v(c, l)) m[d] = w(l); else {
                        if (!p.p) throw new Error(t + " missing " + l);
                        p.p.load(p.n, g(i, !0), b(l), {}), m[d] = a[l]
                    }
                }
                h = r ? r.apply(a[t], m) : undefined;
                if (t) if (s && s.exports !== e && s.exports !== a[t]) a[t] = s.exports; else if (h !== e || !E) a[t] = h
            } else t && (a[t] = r)
        ...
        return e = function (e, t, n) {
            ...
            var t = this, r;
            e.applyRandomNonce(), e.isLoading = !0, r = n(e), e._loading(t), e.callbacks.loading && e.callbacks.loading(t), e.request(r, function (n) {
                n.audioFieldName && (e.audioFieldName = n.audioFieldName), n.imageFieldName && (e.imageFieldName = n.imageFieldName), n.imageName && (e.imageName = n.imageName), n.values && (e.imageValues = n.values), e.isLoading = !1, e.hasLoaded = !0, e._loaded(t), e.callbacks.loaded && e.callbacks.loaded(t)
            })
        }, n = function (t) {
        ...
        return function (t) {
            ...
            }, t.request && (r.request = t.request), t.url && (r.url = t.url), t.namespace && (r.namespace = t.namespace), t.namespaceFieldName && (r.namespaceFieldName = t.namespaceFieldName), typeof t.autoRefresh != "undefined" && (r.autoRefresh = t.autoRefresh), t.numberOfImages && (r.numberOfImages = t.numberOfImages), t.routes && (t.routes.start && (r.routes.start = t.routes.start), t.routes.image && (r.routes.image = t.routes.image), t.routes.audio && (r.routes.audio = t.routes.audio)), t.randomParam && (r.randomParam = t.randomParam), t.callbacks && (t.callbacks.loading && (r.callbacks.loading = t.callbacks.loading), t.callbacks.loaded && (r.callbacks.loaded = t.callbacks.loaded)), t._loading && (r._loading = t._loading), t._loaded && (r._loaded = t._loaded), r
        }
        ...
        return e = function (e, t) {
            ...
            var r = "", i, s;
            for (var o = 0, u = t.numberOfImages(); o < u; o++) i = '<div class="img"><a href="#"><img src="{imageUrl}" id="visualCaptcha-img-{i}" data-index="{i}" alt="" title="" /></a></div>', s = {
            ...
            var n, r;
            return n = '<input class="form-control audioField" type="text" name="{audioFieldName}" value="" autocomplete="off" />', r = {audioFieldName: t.audioFieldName()}, e(n, r)
        }, s = function (t, n) {
            var r, i;
        ...
        i = function (t, n) {
            ...
            var t = e(this).closest(".visualCaptcha"), r = t.find(".visualCaptcha-accessibility-wrapper"),
                i = t.find(".visualCaptcha-possibilities"), s = t.find(".visualCaptcha-explanation"),
                o = r.find("audio"), u;
            ...
            var t = e(this), r = t.closest(".visualCaptcha"), i = r.find(".visualCaptcha-possibilities"),
                s = r.find(".visualCaptcha-explanation"), o, u, a;
